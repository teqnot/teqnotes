...
object NoteAccesses : IntIdTable("note_accesses") {
    ...
    val grantedAt = datetime("granted_at").clientDefault { LocalDateTime.now() }
...
class NoteAccess(id: EntityID<Int>) : IntEntity(id) {
    ...
    var grantedBy by User optionalReferencedOn NoteAccesses.grantedBy
